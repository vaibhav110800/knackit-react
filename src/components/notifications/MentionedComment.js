...
const MentionedComment = () => {
  return (
    <div className="flex my-3  dark:text-white items-center justify-between">
      <div className="flex items-center">
        ...
        <div className="flex flex-col ml-4">
          <p className="text-base">
            <strong>Aayush verma</strong> tagged you in a comment{" "}
            <span className="text-gray-500 ml-2">10d</span>
          </p>
          <p className="my-1 text-gray-500  dark:text-stone-300">
            {" "}
            <Link
              className="text-indigo-600 hover:text-indigo-700 dark:text-indigo-300 transition-colors"
              to="#!"
            >
              @aayush
            </Link>{" "}
...
export default MentionedComment;
