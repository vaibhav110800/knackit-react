    ...
    return (
        <div className="overflow-y-hiden hidden-scrollbar w-full">
            ...
            <div className="bg-indigo-50 min-h-screen -mt-16 flex items-center justify-center">
                <div className="w-full flex">
                    <div className="basis-1/3 flex flex-col items-center justify-center">
                        <div className="text-4xl font-bold text-gray-700 z-10 -translate-x-20 translate-y-4">About Knackit</div>
                        <div className="text-9xl font-bold text-gray-300 rotate-90 translate-x-20 -translate-y-16">ABOUT</div>
                    </div>
                    <div className="basis-2/3 flex items-center justify-end">
                        <img className="-translate-y-16 hidden sm:hidden md:block lg:block xl:block 2xl:block" src="./images/about-us/1.png" alt="" />
                    </div>
                </div>
            </div>
            ...
            <div className="bg-indigo-50 min-h-screen flex items-start justify-center">
                <div className="pt-12 w-4/5 max-w-screen-xl flex flex-col lg:flex-row">

                    <div className="basis-3/6 flex flex-col items-start mr-12">
                        <img className="translate-x-12 pb-8" src="./images/about-us/l1.png" alt="" />
                        ...
                        <div className="text-sm w-11/12 text-justify font-semibold text-gray-500 mb-24">
                    ...
                    <div className="basis-3/6 flex justify-start flex-col">
                        ...
                        <img className="w-2/3 mb-8 translate-x-20" src="./images/about-us/r2.png" alt="" />
