...
const PostSingle = () => {
  return (
    <div className="w-full h-screen overflow-hidden bg-stone-100 xl:px-8 2xl:px-16 sm:px-2 dark:bg-gray-800 overflow-y-hidden from-sky-700 to-indigo-800 flex justify-start">
      ...
      <div className="w-11/12 xl:w-9/12 pl-5 pr-5 border-r-2 border-gray-200 dark:border-gray-700 flex flex-col overflow-y-auto hide-scrollbar">
        ...
        <div className="bg-white w-full min-h-modal overflow-hidden pr-5 rounded-lg">
          <div className="grid grid-cols-2">
            <img
              ...
              alt="Post"
              className="object-cover h-modal pr-5"
            />
            <div className="overflow-y-auto h-modal py-5 hidden-scrolbar">
              ...
              <p className="text-gray px-5 500 text-lg py-8">
                ...
                Asperiores corrupti beatae perferendis libero architecto,
                tempore quae debitis dolorum, illo blanditiis quas.
        ...
        <p className="font-semibold dark:text-white text-lg mt-10 mb-3">
          More posts from iam_Rohan
        </p>
        <div className="grid grid-cols-3 gap-3 my-3">
          <img
            src="https://images.unsplash.com/photo-1612415491873-144fd5e03169?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80"
            alt="Post"
